...
#define SMALLBINS         (64U)                                                
#define TREEBINS          (32U)
#define SMALLBIN_SHIFT    (3U) 
#define SMALLBIN_WIDTH    (SIZE_T_ONE << SMALLBIN_SHIFT)                       
#define TREEBIN_SHIFT     (9U)                                                 

/* Size & request constraints */
...
typedef struct malloc_state {
    ...
    binmap_t smallmap;
    binmap_t treemap; 
    chunk smallbins[SMALLBINS];
    tchunkptr treebins[TREEBINS];  
} mstate;                                                                             

/* Check if address a is within valid range */      
...
/* Functions for operations on small chunks */
...
/* Functions for operations on large/tree chunks */
